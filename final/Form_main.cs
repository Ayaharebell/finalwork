...
namespace final
{
    public partial class Form_main : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        private void Form_main_Load(object sender, EventArgs e)
        {
            CreateMap();
            CreatePlane();
            startButton.Location = new Point(18 * width, 16 * width);
            startButton.Height = 2 * width;
            startButton.Width = 2 * width;
            throwDice.Location = new Point(20 * width, 16 * width);
            throwDice.Height =  2 * width;
            throwDice.Width = 2 * width;
            ...
            board.Enabled = false;
            label1.Location = new Point(19 * width, 13 * width);
        ...
        private String searchLocation(Point pointClick)
        {
            ...
            if (player == 1)
            {
                ...
                if (isHome == 0)
                {
                    for (int i = 0; i < pointsRedFinish.Length; i++)
                    {
            ...
            else if (player == 2)
            {
                ...
                if (isHome == 0)
                {
                    for (int i = 0; i < pointsBlueFinish.Length; i++)
                    {
            ...
            else if (player == 3)
            {
                ...
                if (isHome == 0)
                {
                    for (int i = 0; i < pointsYellowFinish.Length; i++)
                    {
            ...
            else if (player == 4)
            {
                ...
                if (isHome == 0)
                {
                    for (int i = 0; i < pointsGreenFinish.Length; i++)
                    {
        ...
        private Boolean playingToFinish(PictureBox pic,int index,Boolean hasExecuted,int PlaneColor)
        {
            ...
            if (PlaneColor == 1)
            {
                ...
                if (isFinish)
                {
                    pic.Location = pointsRedHome[location];
                }
                else
                {
                    pic.Location = points[location];
            ...
            else if(PlaneColor == 2)
            {
                ...
                if (isFinish)
                {
                    pic.Location = pointsBlueHome[location];
                }
                else
                {
                    pic.Location = points[location];
            ...
            else if (PlaneColor == 3)
            {
                ...
                if (isFinish)
                {
                    pic.Location = pointsYellowHome[location];
                }
                else
                {
                    pic.Location = points[location];
            ...
            else if (PlaneColor == 4)
            {
                ...
                if (isFinish)
                {
                    pic.Location = pointsGreenHome[location];
                }
                else
                {
                    pic.Location = points[location];
                ...
                if (isFinish == 1)
                {
                    if (whichSelect == 0)
                    {
                        ...
                        else if(index+diceNum > 6)
                        {
                            ...
                            red0.Location = pointsRedFinish[index];
                            hasExecuted = true;
                        }
                        //小于6，正常
                        else if(index + diceNum < 6)
                    ...
                    else if (whichSelect == 1)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            red1.Location = pointsRedFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                    ...
                    else if (whichSelect == 2)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            red2.Location = pointsRedFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                    ...
                    else if (whichSelect == 3)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            red3.Location = pointsRedFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
            ...
            if (player == 2)
            {
                ...
                if (isFinish == 1)
                {
                    if (whichSelect == 0)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            blue0.Location = pointsBlueFinish[index];
                            hasExecuted = true;
                        }
                        //小于6，正常
                        else if (index + diceNum < 6)
                    ...
                    else if (whichSelect == 1)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            blue1.Location = pointsBlueFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                    ...
                    else if (whichSelect == 2)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            blue2.Location = pointsBlueFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                    ...
                    else if (whichSelect == 3)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            blue3.Location = pointsBlueFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                ...
                if (isPlaying == 1)
                {
                    if (whichSelect == 0)
                    {
                        hasExecuted = playingToFinish(blue0, index, hasExecuted, 1);
                    }
                    else if (whichSelect == 1)
                    {
                        hasExecuted = playingToFinish(blue1, index, hasExecuted, 1);
                    }
                    else if (whichSelect == 2)
                    {
                        hasExecuted = playingToFinish(blue2, index, hasExecuted, 1);
                    }
                    else if (whichSelect == 3)
                    {
                        hasExecuted = playingToFinish(blue3, index, hasExecuted, 1);
                    }
                }
            }
            if (player == 3)
            {
                ...
                if (isHome == 1)
                {
                    if (diceNum == 6)
                    {
                        if (whichSelect == 0)
                        {
                            yellow0.Location = new Point(4 * width, 14 * width);
                            hasExecuted = true;
                        }
                        else if (whichSelect == 1)
                        {
                            yellow1.Location = new Point(4 * width, 14 * width);
                            hasExecuted = true;
                        }
                        else if (whichSelect == 2)
                        {
                            yellow2.Location = new Point(4 * width, 14 * width);
                            hasExecuted = true;
                        }
                        else if (whichSelect == 3)
                        {
                            yellow3.Location = new Point(4 * width, 14 * width);
                            hasExecuted = true;
                        }
                    }
                }
                ...
                if (isFinish == 1)
                {
                    if (whichSelect == 0)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            yellow0.Location = pointsYellowFinish[index];
                            hasExecuted = true;
                        }
                        //小于6，正常
                        else if (index + diceNum < 6)
                    ...
                    else if (whichSelect == 1)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            yellow1.Location = pointsYellowFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                    ...
                    else if (whichSelect == 2)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            yellow2.Location = pointsYellowFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                    ...
                    else if (whichSelect == 3)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            yellow3.Location = pointsYellowFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                ...
                if (isPlaying == 1)
                {
                    if (whichSelect == 0)
                    {
                        hasExecuted = playingToFinish(yellow0, index, hasExecuted, 1);
                    }
                    else if (whichSelect == 1)
                    {
                        hasExecuted = playingToFinish(yellow1, index, hasExecuted, 1);
                    }
                    else if (whichSelect == 2)
                    {
                        hasExecuted = playingToFinish(yellow2, index, hasExecuted, 1);
                    }
                    else if (whichSelect == 3)
                    {
                        hasExecuted = playingToFinish(yellow3, index, hasExecuted, 1);
                    }
                }
            }
            if (player == 4)
            {
                ...
                if (isFinish == 1)
                {
                    if (whichSelect == 0)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            green0.Location = pointsGreenFinish[index];
                            hasExecuted = true;
                        }
                        //小于6，正常
                        else if (index + diceNum < 6)
                    ...
                    else if (whichSelect == 1)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            green1.Location = pointsGreenFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                    ...
                    else if (whichSelect == 2)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            green2.Location = pointsGreenFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                    ...
                    else if (whichSelect == 3)
                    {
                        ...
                        {
                            index = 12 - index - diceNum;
                            green3.Location = pointsGreenFinish[index];
                            hasExecuted = true;
                        }
                        else if (index + diceNum < 6)
                        {
                ...
                if (isPlaying == 1)
                {
                    if (whichSelect == 0)
                    {
                        hasExecuted = playingToFinish(green0, index, hasExecuted, 1);
                    }
                    else if (whichSelect == 1)
                    {
                        hasExecuted = playingToFinish(green1, index, hasExecuted, 1);
                    }
                    else if (whichSelect == 2)
                    {
                        hasExecuted = playingToFinish(green2, index, hasExecuted, 1);
                    }
                    else if (whichSelect == 3)
                    {
                        hasExecuted = playingToFinish(green3, index, hasExecuted, 1);
                    }
                }
            }
            /*
